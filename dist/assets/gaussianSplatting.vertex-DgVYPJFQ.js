import{t as e}from"./shaderStore-D-XQlhUT.js";import{t}from"./meshUboDeclaration-BATNZvmb.js";import{t as n}from"./sceneUboDeclaration-B96Tfx7b.js";import{A as r,G as i,I as a,L as o,O as s,j as c,k as l,o as u}from"./index-CGZDmgJ_.js";var d=`gaussianSplattingVertexShader`,f=`#include<sceneUboDeclaration>
...
`;e.ShadersStoreWGSL[d]||(e.ShadersStoreWGSL[d]=f);var p=[n,t,i,o,c,r,u,a,l,s];for(let t of p)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var m={name:d,shader:f};export{m as gaussianSplattingVertexShaderWGSL};